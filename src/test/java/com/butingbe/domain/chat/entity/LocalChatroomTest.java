...
class LocalChatroomTest {
  ...
  void incrementCurrentMembers_success() {
    // Given
    LocalChatroom chatroom = LocalChatroom.builder().maxMembers(2).build();
  ...
  void incrementCurrentMembers_throwsException_whenRoomIsFull() {
    // Given
    LocalChatroom chatroom = LocalChatroom.builder().maxMembers(1).build();
  ...
  void decrementCurrentMembers_successAndBoundaryCheck() {
    // Given
    LocalChatroom chatroom = LocalChatroom.builder().maxMembers(5).build();
