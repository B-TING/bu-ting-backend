...
class LocalChatroomControllerTest {
    ...
    void getRoomsByZoneSuccess() throws Exception {
        ...
        mockMvc.perform(get("/chat/rooms/zone")
                ...
                .andDo(document(
                        ...
                        responseFields(
                                fieldWithPath("success").description("응답 성공 여부 (true/false)"), // 💡 status -> success 수정
    ...
    void exitRoomSuccess() throws Exception {
        ...
        mockMvc.perform(delete("/chat/rooms/{roomId}/exit", roomId)
                ...
                .andDo(document(
                        ...
                        responseFields(
                                fieldWithPath("success").description("응답 성공 여부 (true/false)"), // 💡 status 대신 success로 변경!
                                fieldWithPath("message").description("응답 메시지"),
    ...
    void enterRoomSuccess() throws Exception {
        ...
        when(localChatroomService.enterChatRoom(eq(roomId), any(UUID.class))).thenReturn(List.of(mockMessageResponse));
