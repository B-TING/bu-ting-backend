...
public interface TravelRecordBookmarkRepository extends JpaRepository<TravelRecordBookmark, UUID> {

  boolean existsByUser_IdAndTravelRecord_Id(UUID userId, UUID travelRecordId);

  Optional<TravelRecordBookmark> findByUser_IdAndTravelRecord_Id(UUID userId, UUID travelRecordId);
